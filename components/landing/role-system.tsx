...
const roles = [
  {
    ...
    title: "Owner",
    description:
      "Full control. Revenue reports, staff management, settings, and billing — all in one view.",
  },
  {
    icon: ClipboardList,
    title: "Manager",
    description:
      "Day-to-day operations. Add members, process payments, and manage subscriptions.",
  },
  {
    icon: Monitor,
    title: "Receptionist",
    description:
      "Front desk focus. Scan QR codes, sell products, and check member status instantly.",
  },
  {
    icon: Dumbbell,
    title: "Trainer",
    description:
      "Build workout plans, manage bookings, and track client progress over time.",
  },
  {
    icon: User,
    title: "Member",
    description:
      "Personal portal. View your plan, log workouts, and check attendance history.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-xl mb-6 md:mb-16">
          ...
          <p className="text-[15px] md:text-[17px] text-white/70 leading-relaxed max-w-xl">
            Tailored dashboards for every role. From business analytics for
            owners to workout logging for members, everyone gets the tools they
            actually need.
          </p>
        </div>
                    ...
                    >
                      ...
                      <div
                        className={cn(
                          "flex flex-col",
                          i === 0
                            ? "lg:w-[22%] mb-4 lg:mb-0"
                            : hasImage
                              ? "sm:w-[35%] mb-2 sm:mb-0"
                              : "w-full",
                        )}
                      >
                        <p
                        ...
                        >
                          {i === 0 ? (
                            <>
                              ...
                              , staff management, settings, and billing.
                            </>
                          ) : (
                            r.description
                          )}
