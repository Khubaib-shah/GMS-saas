      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-[15px] text-white/80 leading-relaxed mb-8">
            Sell supplements, water bottles, or merchandise directly from the
            dashboard. Every transaction is automatically tracked and added to
            your daily revenue reports.
          </p>
        ...
        <div className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-6">
            ...
            {posItems.map((item, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[11px] text-white/30 bg-white/[0.04] border border-white/[0.06] rounded px-1.5 py-0.5">
                    ×{item.qty}
                  </span>
                </div>
          ...
          <button
            onClick={() => {
              setCharged(true);
              setTimeout(() => setCharged(false), 2000);
            }}
          ...
          >
            <span className="flex items-center justify-center gap-2">
              {charged ? (
                <>
                  <Check className="w-4 h-4" strokeWidth={2.5} /> Payment
                  recorded
                </>
              ) : (
