...
const testimonials = [
  {
    quote:
      "We used to lose 15–20 members every month who were training with expired plans. GymFlow stopped that on day one. Revenue went up 22% in the first month.",
  ...
  {
    quote:
      "My receptionist used to spend 20 minutes every morning checking the register. Now she just scans QR codes. The whole check-in takes 2 seconds.",
    name: "Sadia Malik",
  ...
  {
    quote:
      "The POS module alone saved us. We were tracking supplement sales in a notebook. Now everything is digital and I can see exactly how much product revenue we make.",
    name: "Hamza Sheikh",
  ...
  {
    quote:
      "We manage 3 branches and GymFlow is the only tool that lets us see everything in one place. The multi-branch reports are incredibly useful.",
    name: "Hassan Ali",
  ...
  {
    quote:
      "Switching from spreadsheets to GymFlow was the best decision we made. Member retention improved because we now reach out before subscriptions expire.",
    name: "Sara Mahmood",
  ...
  {
    quote:
      "The role-based access is perfect. My receptionist only sees what she needs, trainers manage clients, and I get the full financial picture.",
    name: "Usman Tariq",
