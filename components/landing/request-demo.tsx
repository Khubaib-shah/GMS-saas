...
export const RequestDemo = () => {
  ...
  return (
    <section
      id="request-demo"
      className="flex-1 flex flex-col items-center justify-center py-6 md:py-20 px-2 md:px-6 relative overflow-hidden"
    >
      {/* Background Effects */}
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center relative z-10">
        ...
        <div className="order-1 lg:order-1">
          ...
          <p className="text-lg text-slate-400 mb-10 max-w-lg leading-relaxed">
            Join thousands of gym owners who use GymFlow to automate their
            business. Get a personalized walkthrough of the platform.
          </p>
            ...
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center text-center py-12 gap-4">
                ...
                <p className="text-slate-400 max-w-xs">
                  Thanks! We&apos;ll reach out to you within 1 business day to
                  schedule your demo.
                </p>
              </div>
            ) : (
              <>
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                  ...
                  <InputField
                    ...
                    onChange={(val) =>
                      setFormData((prev) => ({ ...prev, gymName: val }))
                    }
                    className="bg-white/5 border-white/10 focus-visible:ring-primary h-12 text-white"
                  />

                  <div className="space-y-2">
                    <Label htmlFor="members" className="text-slate-400">
