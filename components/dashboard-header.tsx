...
export function DashboardHeader({
  ...
  return (
    <div className={cn("flex flex-col md:flex-row md:items-center justify-between mb-6 md:mb-12 relative gap-4 md:gap-6", className)}>
      <div className="relative">
        ...
        <div>
          ...
          {description && (
            <div className="text-slate-500 font-bold uppercase tracking-widest text-[10px] md:mt-4 flex items-center gap-2">
