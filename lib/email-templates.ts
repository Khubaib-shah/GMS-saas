      ...
      <div style="background: rgba(255,255,255,0.03); border-radius: 16px; padding: 25px; margin: 30px 0; border: 1px solid rgba(255,255,255,0.05);">
        <table style="width: 100%; border-collapse: collapse; font-size: 13px; text-transform: uppercase; letter-spacing: 1px;">
          <tr>
            ...
            <td style="text-align: right; color: #fff; padding-bottom: 10px; font-family: monospace;">#${data.paymentId.slice(-8).toUpperCase()}</td>
          </tr>
          <tr>
            <td style="color: #64748b; padding-bottom: 10px;">Date</td>
            <td style="text-align: right; color: #fff; padding-bottom: 10px;">${formatDate(data.date)}</td>
          </tr>
          <tr>
            <td style="color: #64748b; padding-bottom: 10px;">Membership</td>
            <td style="text-align: right; color: #fff; padding-bottom: 10px;">${data.planName}</td>
          </tr>
          <tr style="border-top: 1px solid rgba(255,255,255,0.1);">
            <td style="color: #fff; font-weight: 900; padding-top: 15px; font-size: 16px;">Total Paid</td>
