        ...
        <div className="p-4 md:p-8 space-y-6 md:space-y-10 animate-in fade-in duration-700">
            ...
            >
                <div className="flex flex-wrap items-center gap-2 md:gap-3 relative z-10 w-full md:w-auto">
                    <Button variant="outline" className="flex-1 md:flex-none h-10 md:h-12 rounded-xl md:rounded-2xl border-white/5 bg-slate-950/20 text-[9px] md:text-[10px] font-black uppercase tracking-widest px-4 md:px-6 hover:bg-white/5 transition-all">
